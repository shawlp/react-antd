...
import { useGetCurrentUser } from '@service/index'
...
const columns: ProColumns<TableListItem>[] = [
  ...
  },
  {
    title: '应用名称',
    dataIndex: 'name',
    render: (_) => <a href="www.baidu.com">{_}</a>,
  ...
  },
  {
    ...
    valueType: 'option',
    render: () => [
      <a key="link" href="www.baidu.com">
        链路
      </a>,
      <a key="link2" href="www.baidu.com">
        报警
      </a>,
      <a key="link3" href="www.baidu.com">
        监控
      </a>,
      <TableDropdown
        key="actionGroup"
